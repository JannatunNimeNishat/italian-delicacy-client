...
const Register = () => {
    ...
    return (
        ...
        <form className=' w-[450px] px-10 text-center border mx-auto'>
            ...
            <input className='border-b-2 bg-black w-full mt-10 px-2' type="text" name="name" placeholder='please enter your name' />
            <br />
            ...
            <br />
            <input className='border-b-2 bg-black w-full mt-8 px-2' type="text" name="photURL" placeholder='please enter your photURL' />
            <br />
